...
import static com.auth.infrastructure.exceptions.ExceptionMessages.USER_NOT_FOUND;
import static com.auth.infrastructure.exceptions.ExceptionMessages.USER_NOT_FOUND_EMAIL;

import java.util.UUID;
import lombok.RequiredArgsConstructor;
import com.auth.features.user.dto.UserFilter;
import com.auth.features.user.entity.User;
import com.auth.features.user.repository.UserRepository;
import com.auth.features.user.repository.UserSpecification;
import com.auth.infrastructure.config.security.services.UserDetailsServiceImpl;
import com.auth.infrastructure.mappers.UserMapper;
